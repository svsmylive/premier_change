...
@section('content')
    <div class="container py-4">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form class="row g-2" method="GET" action="{{ route('partners.index') }}">
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a class="btn btn-outline-secondary w-100" href="{{ route('partners.index') }}">Сброс</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    @forelse($partners as $partner)
                        <tr>
                            ...
                            <td class="text-muted">
                                {{ \Illuminate\Support\Str::limit($partner->comment, 140) }}
                            </td>
                            <td class="text-end">
                                ...
                                <button type="button"
                                        ...
                                        data-action="{{ route('partners.destroy', $partner) }}"
            ...
            <div class="modal-content">
                <form method="POST" id="deleteForm">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Удалить партнёра</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <div class="modal-body">
                        <div class="alert alert-warning mb-0">
                            Вы уверены, что хотите удалить партнёра: <b id="deleteName"></b>?
                        </div>
                    </div>
